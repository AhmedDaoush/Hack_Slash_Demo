...
void AHack_SlashCharacter::Tick(float DeltaSeconds)
{
...
void AHack_SlashCharacter::BeginPlay()
{
	Super::BeginPlay();
	GetCapsuleComponent()->OnComponentBeginOverlap.AddDynamic(this, &AHack_SlashCharacter::OnOverlapBegin);
}
...
void AHack_SlashCharacter::MoveForward(float Value)
{
	...
	AddMovementInput(FVector(1, 0, 0), bCanMove ? Value : 0);
}

void AHack_SlashCharacter::MoveRight(float Value)
{
	AddMovementInput(FVector(0, 1, 0), bCanMove ? Value : 0);
}



void AHack_SlashCharacter::SetupPlayerInputComponent(UInputComponent* PlayerInputComponent)
{
